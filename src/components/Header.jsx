            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                >
                        ...
                        {navLinks.map((link) => {
                            ...
                            return (
                                <li key={link.tab}>
                                    ...
                                    >
                                        <IconComponent className={`size-4 mr-2 ${isActive ? 'text-white md:text-blue-700 dark:md:text-blue-500' : 'text-gray-500 dark:text-gray-400'}`} />
                                        {link.name}
                                    </button>
                                </li>
                            );
                    ...
                    <button
                        ...
                        className="ms-20 p-2 rounded-lg text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 transition-colors duration-300"
                    >
                        {isDark ? '☀️' : '🌙'}
                    </button>
                </section>
